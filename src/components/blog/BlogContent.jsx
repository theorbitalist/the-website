      ...
      <div className="max-w-[1216px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="bg-[#F9FAFB] border-l-4 border-(--red) p-6 lg:p-8">
              <p className="text-lg lg:text-xl font-medium text-(--grey) italic leading-relaxed mb-4">
              ...
              <p className="text-sm text-(--grey)">— Maya Louvière, Entrepreneur</p>
            </div>
            ...
            <div>
              <h2 className="text-xl lg:text-2xl font-semibold text-(--grey) mb-4 lg:mb-6">Software and tools</h2>
              <p className="text-base leading-relaxed text-(--grey) mb-4">
            ...
            <div>
              <h2 className="text-xl lg:text-2xl font-semibold text-(--grey) mb-4 lg:mb-6">Other resources</h2>
              <p className="text-base leading-relaxed text-(--grey) mb-4">
              ...
              <ol className="space-y-2 list-decimal list-inside text-base text-(--grey)">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div>
              <h2 className="text-xl lg:text-2xl font-semibold text-(--grey) mb-4 lg:mb-6">Conclusion</h2>
              <p className="text-base leading-relaxed text-(--grey) mb-4">
